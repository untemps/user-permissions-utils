...
/**
 * Watches the `midi` permission and resolves with `'granted'` once it is granted.
 *
 ...
 */
const getMidiPermission = async (options?: GetPermissionOptions): Promise<'granted'> => getPermission('midi', options)
