...
/**
 * Watches the `camera` permission and resolves with `'granted'` once it is granted.
 *
 ...
 */
const getCameraPermission = async (options?: GetPermissionOptions): Promise<'granted'> =>
	getPermission('camera', options)
