...
/**
 * Watches the `microphone` permission and resolves with `'granted'` once it is granted.
 *
 ...
 */
const getMicrophonePermission = async (options?: GetPermissionOptions): Promise<'granted'> =>
	getPermission('microphone', options)
